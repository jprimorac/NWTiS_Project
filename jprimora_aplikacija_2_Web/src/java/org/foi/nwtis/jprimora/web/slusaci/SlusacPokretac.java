...
public class SlusacPokretac implements ServletContextListener {
    ...
    String direktorij = sce.getServletContext().getRealPath("/WEB-INF")
        ...
        List<Korisnici> aktivniKorisnici = new ArrayList<>();
        sce.getServletContext().setAttribute("aktivniKorisnici", aktivniKorisnici);
        obradaPoruka = new ObradaPoruka(konfig, bpk);
        obradaPoruka.start();
